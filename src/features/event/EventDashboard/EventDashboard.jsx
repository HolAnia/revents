        ...
        return (
            <Grid>
                ...
                <Grid.Column width={6}>
                    ...
                    {isOpen && <EventForm key={selectedEvent ? selectedEvent.id : 0} updateEvent={this.handleUpdateEvent} selectedEvent = {selectedEvent} createEvent={this.handleCreateNewEvent} cancelFormOpen = {this.handleFormCancel}/> }
                </Grid.Column>
            </Grid>
        )
    }
